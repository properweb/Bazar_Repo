        ...
        <div class="row gx-4 mb-2">
            <div class="col-auto">
                <div class="avatar avatar-xl position-relative">
                    <img src="{{$data[0]['featured_image']}}" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                </div>
            </div>
                ...
                <div class="col-12 col-xl-12">
                    <div class="card card-plain h-100">
                        ...
                        <div class="card-body p-3">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Product Type:</strong> &nbsp; {{$data[0]['category']}}</li>
                                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Product Made IN:</strong> &nbsp; {{$data[0]['country']}}</li>
                            ...
                            <div class="card card-blog card-plain">
                                <div class="card-header p-0 mt-n4 mx-3">
                                    <a class="d-block shadow-xl border-radius-xl">
                                        <img src="{{$img['image']}}" alt="img-blur-shadow" class="img-fluid shadow border-radius-lg">
                                    </a>
                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{$variation['preview_images']}}" class="avatar avatar-sm me-3 border-radius-lg" alt="user6">
                                                    </div>

                                                </div>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{$variation['value1']}}</p>

                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-xs font-weight-bold mb-0">{{$variation['value2']}}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{$variation['value3']}}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{$variation['sku']}}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{$variation['usd_wholesale_price']}}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{$variation['usd_retail_price']}}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{$variation['inventory']}}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{$variation['weight']}}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{$variation['length']}}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{$variation['width']}}{{$variation['width_unit']}}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{$variation['height']}}{{$variation['height_unit']}}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{$variation['tariff_code']}}</p>
                                            </td>
                                        </tr>
                                        <?php }?>
                                        </tbody>
                                ...
                                <div class="table-responsive p-0">
                                    ...
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-xs font-weight-bold mb-0">{{$prerPack['style']}}</p>

                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-xs font-weight-bold mb-0">{{$prerPack['pack_name']}}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{$prerPack['size_ratio']}}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{$prerPack['size_range_value']}}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{$prerPack['packs_price']}}</p>
                                            </td>
