...
<html lang="en-US">
    ...
    <head>
        ...
        <meta name="description" content="New Order Template.">
        <style type="text/css">
            .btn {
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            ...
                                            <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                A new order placed, please check your Bazar account or click the below link to view order details.
                                            </p>
                                            <a href="{{$url}}" class="btn">view order</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height:40px;">&nbsp;</td>
